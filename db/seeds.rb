...
invoice1 = Invoice.create!(invoice_number: "1", customer_id:dougmorrell.id, date: '10/01/21', description: 'Changes light switches in garage', subtotal: 36, tax: 3.24, grand_total:39.24, payment_status: false, payment_type: " ", payment_number: "")
...
invoice3 = Invoice.create!(invoice_number: "3", customer_id:trenthorton.id, date: '10/16/21', description: 'Put new light switches in the house', subtotal:0, tax: 0, grand_total:0, payment_status: false, payment_type: " ", payment_number: "")
...
invoice_3_materials = InvoiceMaterial.create!(invoice_id:invoice3.id, material_id: light_switch.id, quantity:2, total:8)
invoice_3_labor = InvoiceMaterial.create!(invoice_id:invoice3.id, material_id: labor.id, quantity:0.5, total:10)
